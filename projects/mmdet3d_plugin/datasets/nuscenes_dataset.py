...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def __init__(self, queue_length=4, bev_size=(200, 200), overlap_test=False, data_conf=None, *args, **kwargs):
        ...
        # parameters for generating segmentation mask
        map_xbound, map_ybound = data_conf['xbound'], data_conf['ybound']
        ...
        self.map_patch_size = (patch_h, patch_w)    # real-world size of bev view
        self.map_canvas_size = (canvas_h, canvas_w) # grid size of bev view
    ...
    def prepare_train_data(self, index):
        ...
        queue = [] # queue for history frames
